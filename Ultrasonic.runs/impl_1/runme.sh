...
HD_PWD='E:/Vivado_Projects/Ultrasonic/Ultrasonic.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AutoBreakSystem.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source AutoBreakSystem.tcl -notrace

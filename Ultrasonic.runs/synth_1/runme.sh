...
HD_PWD='E:/Vivado_Projects/Ultrasonic/Ultrasonic.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AutoBreakSystem.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AutoBreakSystem.tcl
